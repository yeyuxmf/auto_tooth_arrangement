...
3.pytorch3D 0.7.4    
   Considering that some friends are unable to install Pytorch3D under Windows, here is an installation package for Pytorch3D. I am using Conda 4.10.3. You need to download and unzip the file, and place the corresponding file directly under the site packages directory in your environment.
