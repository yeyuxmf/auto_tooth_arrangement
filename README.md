...
3. $f_3$: Position Persistence Energy (Displacement Constraint)
...
4. $f_4$: Ideal Distribution Energy (Spacing)
...
6. $f_6$: Proximal Contact Energy (Gap Goal)
